...
import org.dev.domain.validation.handlers.ThrowsValidationHandler;
...
public class CategoryTest {
    ...
    public void givenAnInvalidNullName_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        ...
        final var expectedProblemCount = 1;
        ...
        Assertions.assertEquals(expectedProblemCount, actualException.getProblems().size());
