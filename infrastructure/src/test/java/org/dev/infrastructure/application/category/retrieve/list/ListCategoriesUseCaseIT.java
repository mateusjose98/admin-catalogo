package org.dev.infrastructure.application.category.retrieve.list;
...
public class ListCategoriesUseCaseIT {
    ...
    void mockUp() {
        ...
        esperar(5);
        Category nexflixOriginals = Category.newCategory("Netflix Originals", "Títulos de autoria da Netflix", true);
        Category amazonOriginals = Category.newCategory("Amazon Originals", "Títulos de autoria da Amazon Prime", true);
        Category documentarios = Category.newCategory("Documentários", null, true);
        Category sports = Category.newCategory("Sports", null, true);
        Category kids = Category.newCategory("Kids", "Categoria para crianças", true);
        esperar(10);
