package org.dev.infrastructure.application.category.update;
...
public class UpdateCategoryUseCaseIT {
    ...
    public void givenAInvalidName_whenCallsUpdateCategory_thenShouldReturnDomainException() {
        ...
        Assertions.assertEquals(expectedErrorCount, notification.getProblems().size());
        Assertions.assertEquals(expectedErrorMessage, notification.firstProblem().message());
