package org.dev.infrastructure.infra.api;

import com.fasterxml.jackson.databind.ObjectMapper;
import org.dev.application.category.create.CreateCategoryOutput;
...
import org.dev.application.category.retrieve.get.CategoryOutput;
...
import org.dev.application.category.update.UpdateCategoryOutput;
...
import org.dev.infrastructure.ControllerTest;
import org.dev.infrastructure.category.models.CreateCategoryRequest;
import org.dev.infrastructure.category.models.UpdateCategoryRequest;
...
//                .with(ApiTest.CATEGORIES_JWT)
        ...
        response.andExpect(status().isUnprocessableEntity())
                ...
                .andExpect(jsonPath("$.problems[0].message", equalTo(expectedMessage)));
    ...
    public void givenAInvalidCommand_whenCallsCreateCategory_thenShouldReturnDomainException() throws Exception {
        ...
        when(createCategoryUseCase.execute(any()))
                .thenThrow(DomainException.with(new Problem(expectedMessage)));
...
//                .with(ApiTest.CATEGORIES_JWT)
        ...
        response.andExpect(status().isUnprocessableEntity())
                .andExpect(header().string("Content-Type", MediaType.APPLICATION_JSON_VALUE))
                .andExpect(jsonPath("$.problems", hasSize(expectedErrorCount)))
                .andExpect(jsonPath("$.problems[0].message", equalTo(expectedMessage)));
