package org.dev.infrastructure.infra.category;
...
import org.dev.infrastructure.category.CategoryMySQLGateway;
...
public class CategoryMySQLGatewayTest {
    ...
    public void givenAValidCategory_whenCallsCreate_shouldReturnANewCategory() {
        ...
        final CategoryJpaEntity entity = categoryRepository.findById(actualCategory.getId().getValue()).get();
        ...
        Assertions.assertEquals(aCategory.getCreatedAt(), entity.getCreatedAt());
