...
import org.dev.application.castmember.create.CreateCastMemberOutput;
...
import org.dev.application.castmember.update.UpdateCastMemberOutput;
...
import org.dev.infrastructure.castmember.models.UpdateCastMemberRequest;
...
//                //.with(ApiTest.CAST_MEMBERS_JWT)
    ...
    public void givenAnInvalidName_whenCallsCreateCastMember_shouldReturnNotification() throws Exception {
        ...
        when(createCastMemberUseCase.execute(any()))
                .thenThrow(NotificationException.with(new Problem(expectedErrorMessage)));
